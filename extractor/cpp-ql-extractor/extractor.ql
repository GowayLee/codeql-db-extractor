...
class DB_attribute extends @attribute {
  string toString() { result = "DB_attribute" }
}

class DB_attribute_arg extends @attribute_arg {
...
class DB_comment extends @comment {
  string toString() { result = "DB_comment" }
}

class DB_compilation extends @compilation {
...
class DB_derivation extends @derivation {
  string toString() { result = "DB_derivation" }
}

class DB_derivedtype extends @derivedtype {
  string toString() { result = "DB_derivedtype" }
}

class DB_diagnostic extends @diagnostic {
...
class DB_enclosingfunction_child extends @enclosingfunction_child {
  string toString() { result = "DB_enclosingfunction_child" }
}
...
class DB_expr extends @expr {
  string toString() { result = "DB_expr" }
}

class DB_exprparent extends @exprparent {
  string toString() { result = "DB_exprparent" }
}

class DB_externalDataElement extends @externalDataElement {
  string toString() { result = "DB_externalDataElement" }
}

class DB_file extends @file {
  string toString() { result = "DB_file" }
}

class DB_folder extends @folder {
...
class DB_fun_decl extends @fun_decl {
  string toString() { result = "DB_fun_decl" }
}

class DB_funbindexpr extends @funbindexpr {
  string toString() { result = "DB_funbindexpr" }
}

class DB_function extends @function {
  string toString() { result = "DB_function" }
}

class DB_globalvariable extends @globalvariable {
...
class DB_jumporlabel extends @jumporlabel {
  string toString() { result = "DB_jumporlabel" }
}

class DB_lambdacapture extends @lambdacapture {
...
class DB_location_default extends @location_default {
  string toString() { result = "DB_location_default" }
}

class DB_macroinvocation extends @macroinvocation {
  string toString() { result = "DB_macroinvocation" }
}

class DB_mangledname extends @mangledname {
  string toString() { result = "DB_mangledname" }
}

class DB_member extends @member {
  string toString() { result = "DB_member" }
}
...
class DB_namequalifiableelement extends @namequalifiableelement {
  string toString() { result = "DB_namequalifiableelement" }
}

class DB_namequalifier extends @namequalifier {
  string toString() { result = "DB_namequalifier" }
}

class DB_namequalifyingelement extends @namequalifyingelement {
  string toString() { result = "DB_namequalifyingelement" }
}

class DB_namespace extends @namespace {
  string toString() { result = "DB_namespace" }
}

class DB_namespace_decl extends @namespace_decl {
  string toString() { result = "DB_namespace_decl" }
}

class DB_namespacembr extends @namespacembr {
...
class DB_parameter extends @parameter {
  string toString() { result = "DB_parameter" }
}

class DB_parameterized_element extends @parameterized_element {
...
class DB_preprocdirect extends @preprocdirect {
  string toString() { result = "DB_preprocdirect" }
}

class DB_ptrtomember extends @ptrtomember {
...
class DB_routinetype extends @routinetype {
  string toString() { result = "DB_routinetype" }
}

class DB_sizeof_or_alignof extends @sizeof_or_alignof {
  string toString() { result = "DB_sizeof_or_alignof" }
}

class DB_sourceline extends @sourceline {
  string toString() { result = "DB_sourceline" }
}

class DB_specialnamequalifyingelement extends @specialnamequalifyingelement {
  string toString() { result = "DB_specialnamequalifyingelement" }
}

class DB_specifier extends @specifier {
  string toString() { result = "DB_specifier" }
}

class DB_static_assert extends @static_assert {
  string toString() { result = "DB_static_assert" }
}

class DB_stmt extends @stmt {
...
class DB_stmtparent extends @stmtparent {
  string toString() { result = "DB_stmtparent" }
}

class DB_type extends @type {
  string toString() { result = "DB_type" }
}

class DB_type_decl extends @type_decl {
...
class DB_user_or_decltype extends @user_or_decltype {
  string toString() { result = "DB_user_or_decltype" }
}

class DB_usertype extends @usertype {
  string toString() { result = "DB_usertype" }
}

class DB_using extends @using {
...
class DB_var_decl extends @var_decl {
  string toString() { result = "DB_var_decl" }
}

class DB_varbindexpr extends @varbindexpr {
  string toString() { result = "DB_varbindexpr" }
}

class DB_variable extends @variable {
  string toString() { result = "DB_variable" }
}

class DB_xmlattribute extends @xmlattribute {
  string toString() { result = "DB_xmlattribute" }
}

class DB_xmlcharacters extends @xmlcharacters {
  string toString() { result = "DB_xmlcharacters" }
}

class DB_xmlcomment extends @xmlcomment {
  string toString() { result = "DB_xmlcomment" }
}

class DB_xmldtd extends @xmldtd {
  string toString() { result = "DB_xmldtd" }
}

class DB_xmlelement extends @xmlelement {
  string toString() { result = "DB_xmlelement" }
}

class DB_xmllocatable extends @xmllocatable {
  string toString() { result = "DB_xmllocatable" }
}

class DB_xmlnamespace extends @xmlnamespace {
  string toString() { result = "DB_xmlnamespace" }
}

class DB_xmlnamespaceable extends @xmlnamespaceable {
  string toString() { result = "DB_xmlnamespaceable" }
}

class DB_xmlparent extends @xmlparent {
...
query predicate get_compilation_build_mode(DB_compilation id, int mode) {
  compilation_build_mode(id, mode)
}

query predicate get_compilation_compiling_files(DB_compilation id, int num, DB_file file) {
  compilation_compiling_files(id, num, file)
}

query predicate get_compilation_time(DB_compilation id, int num, int kind, float seconds) {
...
query predicate get_compilation_finished(DB_compilation id, float cpu_seconds, float elapsed_seconds) {
...
query predicate get_numlines(DB_sourceline element_id, int num_lines, int num_code, int num_comment) {
...
query predicate get_extractor_version(string codeql_version, string frontend_version) {
  extractor_version(codeql_version, frontend_version)
}

query predicate get_fileannotations(DB_file id, int kind, string name, string value) {
  fileannotations(id, kind, name, value)
}

query predicate get_inmacroexpansion(DB_element id, DB_macroinvocation inv) {
  inmacroexpansion(id, inv)
}

query predicate get_affectedbymacroexpansion(DB_element id, DB_macroinvocation inv) {
...
query predicate get_macroparent(DB_macroinvocation id, DB_macroinvocation parent_id) {
  macroparent(id, parent_id)
}

query predicate get_macrolocationbind(DB_macroinvocation id, DB_location_default location) {
...
query predicate get_function_return_type(DB_function id, DB_type return_type) {
...
query predicate get_coroutine_new(DB_function function, DB_function new) {
  coroutine_new(function, new)
}

query predicate get_coroutine_delete(DB_function function, DB_function delete) {
...
query predicate get_member_function_this_type(DB_function id, DB_type this_type) {
...
query predicate get_fun_decl_throws(DB_fun_decl fun_decl, int index, DB_type type_id) {
...
query predicate get_fun_decl_empty_noexcept(DB_fun_decl fun_decl) {
  fun_decl_empty_noexcept(fun_decl)
}

query predicate get_fun_decl_typedef_type(DB_fun_decl fun_decl, DB_usertype typedeftype_id) {
  fun_decl_typedef_type(fun_decl, typedeftype_id)
}

query predicate get_fun_requires(DB_fun_decl id, int kind, DB_expr constraint) {
  fun_requires(id, kind, constraint)
}

query predicate get_param_decl_bind(DB_var_decl id, int index, DB_fun_decl fun_decl) {
...
query predicate get_type_decls(DB_type_decl id, DB_type type_id, DB_location_default location) {
...
query predicate get_using_container(DB_element parent, DB_using child) {
...
query predicate get_globalvariables(DB_globalvariable id, DB_type type_id, string name) {
  globalvariables(id, type_id, name)
}

query predicate get_localvariables(DB_localvariable id, DB_type type_id, string name) {
  localvariables(id, type_id, name)
}

query predicate get_autoderivation(DB_variable var, DB_type derivation_type) {
  autoderivation(var, derivation_type)
}

query predicate get_orphaned_variables(DB_localvariable var, DB_function function) {
...
query predicate get_derivedtypes(DB_derivedtype id, string name, int kind, DB_type type_id) {
  derivedtypes(id, name, kind, type_id)
}

query predicate get_pointerishsize(DB_derivedtype id, int size, int alignment) {
  pointerishsize(id, size, alignment)
}

query predicate get_arraysizes(DB_derivedtype id, int num_elements, int bytesize, int alignment) {
  arraysizes(id, num_elements, bytesize, alignment)
}

query predicate get_tupleelements(DB_derivedtype id, int num_elements) {
...
query predicate get_mangled_name(DB_declaration id, DB_mangledname mangled_name, boolean is_complete) {
...
query predicate get_class_template_argument_value(DB_usertype type_id, int index, DB_expr arg_value) {
  class_template_argument_value(type_id, index, arg_value)
}

query predicate get_is_proxy_class_for(DB_usertype id, DB_user_or_decltype templ_param_id) {
...
query predicate get_routinetypes(DB_routinetype id, DB_type return_type) {
  routinetypes(id, return_type)
}

query predicate get_routinetypeargs(DB_routinetype routine, int index, DB_type type_id) {
  routinetypeargs(routine, index, type_id)
}

query predicate get_ptrtomembers(DB_ptrtomember id, DB_type type_id, DB_type class_id) {
...
query predicate get_funspecifiers(DB_function func_id, DB_specifier spec_id) {
  funspecifiers(func_id, spec_id)
}

query predicate get_varspecifiers(DB_accessible var_id, DB_specifier spec_id) {
  varspecifiers(var_id, spec_id)
}

query predicate get_explicit_specifier_exprs(DB_function func_id, DB_expr constant) {
...
query predicate get_attribute_arg_value(DB_attribute_arg arg, string value) {
  attribute_arg_value(arg, value)
}

query predicate get_attribute_arg_type(DB_attribute_arg arg, DB_type type_id) {
  attribute_arg_type(arg, type_id)
}

query predicate get_attribute_arg_constant(DB_attribute_arg arg, DB_expr constant) {
  attribute_arg_constant(arg, constant)
}

query predicate get_attribute_arg_expr(DB_attribute_arg arg, DB_expr expr) {
  attribute_arg_expr(arg, expr)
}

query predicate get_attribute_arg_name(DB_attribute_arg arg, string name) {
  attribute_arg_name(arg, name)
}

query predicate get_typeattributes(DB_type type_id, DB_attribute spec_id) {
  typeattributes(type_id, spec_id)
}

query predicate get_funcattributes(DB_function func_id, DB_attribute spec_id) {
  funcattributes(func_id, spec_id)
}

query predicate get_varattributes(DB_accessible var_id, DB_attribute spec_id) {
  varattributes(var_id, spec_id)
}

query predicate get_namespaceattributes(DB_namespace namespace_id, DB_attribute spec_id) {
  namespaceattributes(namespace_id, spec_id)
}

query predicate get_stmtattributes(DB_stmt stmt_id, DB_attribute spec_id) {
  stmtattributes(stmt_id, spec_id)
}

query predicate get_unspecifiedtype(DB_type type_id, DB_type unspecified_type_id) {
  unspecifiedtype(type_id, unspecified_type_id)
}

query predicate get_member(DB_type parent, int index, DB_member child) {
  member(parent, index, child)
}

query predicate get_enclosingfunction(DB_enclosingfunction_child child, DB_function parent) {
...
query predicate get_derspecifiers(DB_derivation der_id, DB_specifier spec_id) {
  derspecifiers(der_id, spec_id)
}

query predicate get_direct_base_offsets(DB_derivation der_id, int offset) {
...
query predicate get_comments(DB_comment id, string contents, DB_location_default location) {
  comments(id, contents, location)
}

query predicate get_commentbinding(DB_comment id, DB_element element) {
  commentbinding(id, element)
}

query predicate get_exprconv(DB_expr converted, DB_expr conversion) {
...
query predicate get_exprparents(DB_expr expr_id, int child_index, DB_exprparent parent_id) {
...
query predicate get_specialnamequalifyingelements(DB_specialnamequalifyingelement id, string name) {
...
query predicate get_expr_deallocator(DB_new_or_delete_expr expr, DB_function func, int form) {
...
query predicate get_bitfield(DB_variable id, int bits, int declared_bits) {
...
query predicate get_expr_reuse(DB_expr reuse, DB_expr original, int value_category) {
  expr_reuse(reuse, original, value_category)
}

query predicate get_expr_types(DB_expr id, DB_type typeid, int value_category) {
  expr_types(id, typeid, value_category)
}

query predicate get_compound_requirement_is_noexcept(DB_compound_requirement expr) {
  compound_requirement_is_noexcept(expr)
}

query predicate get_new_allocated_type(DB_new_expr expr, DB_type type_id) {
  new_allocated_type(expr, type_id)
}

query predicate get_new_array_allocated_type(DB_new_array_expr expr, DB_type type_id) {
...
query predicate get_condition_decl_bind(DB_condition_decl expr, DB_declaration decl) {
...
query predicate get_fold(DB_foldexpr expr, string operator, boolean is_left_fold) {
  fold(expr, operator, is_left_fold)
}

query predicate get_stmts(DB_stmt id, int kind, DB_location_default location) {
...
query predicate get_constexpr_if_then(DB_stmt_constexpr_if constexpr_if_stmt, DB_stmt then_id) {
  constexpr_if_then(constexpr_if_stmt, then_id)
}

query predicate get_constexpr_if_else(DB_stmt_constexpr_if constexpr_if_stmt, DB_stmt else_id) {
...
query predicate get_while_body(DB_stmt_while while_stmt, DB_stmt body_id) {
  while_body(while_stmt, body_id)
}

query predicate get_do_body(DB_stmt_end_test_while do_stmt, DB_stmt body_id) {
  do_body(do_stmt, body_id)
}

query predicate get_switch_initialization(DB_stmt_switch switch_stmt, DB_stmt init_id) {
  switch_initialization(switch_stmt, init_id)
}

query predicate get_switch_case(DB_stmt_switch switch_stmt, int index, DB_stmt_switch_case case_id) {
  switch_case(switch_stmt, index, case_id)
}

query predicate get_switch_body(DB_stmt_switch switch_stmt, DB_stmt body_id) {
  switch_body(switch_stmt, body_id)
}

query predicate get_for_initialization(DB_stmt_for_or_range_based_for for_stmt, DB_stmt init_id) {
  for_initialization(for_stmt, init_id)
}

query predicate get_for_condition(DB_stmt_for for_stmt, DB_expr condition_id) {
  for_condition(for_stmt, condition_id)
}

query predicate get_for_update(DB_stmt_for for_stmt, DB_expr update_id) {
...
query predicate get_stmt_decl_entry_bind(DB_stmt_decl stmt, int num, DB_element decl_entry) {
  stmt_decl_entry_bind(stmt, num, decl_entry)
}

query predicate get_blockscope(DB_stmt_block block, DB_parameterized_element enclosing) {
  blockscope(block, enclosing)
}

query predicate get_jumpinfo(DB_jumporlabel id, string str, DB_stmt target) {
  jumpinfo(id, str, target)
}

query predicate get_preprocdirects(DB_preprocdirect id, int kind, DB_location_default location) {
  preprocdirects(id, kind, location)
}

query predicate get_preprocpair(DB_ppd_branch begin, DB_preprocdirect elseelifend) {
